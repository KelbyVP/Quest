...
// Base class for GameInstance, should be blueprinted and then set it to be the default in project settings
UCLASS()
...
public:
	// Constructor
	UQuestGameInstanceBase();

	/** List of inventory items to add to new players */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Inventory")
		TMap<FPrimaryAssetId, FQuestItemData> DefaultInventory;
	...
	*/
	UFUNCTION(BlueprintCallable, Category = Inventory)
		void AddDefaultInventory(UQuestSaveGame* SaveGame, bool bRemoveExtra = false);

	/** Returns true if this is a valid inventory slot */
	UFUNCTION(BlueprintCallable, Category = Inventory)
		bool IsValidItemSlot(FQuestItemSlot ItemSlot) const;
	...
	UFUNCTION(BlueprintCallable, Category = Save)
		UQuestSaveGame* GetCurrentSaveGame();
...
protected:
	...
	UPROPERTY()
		UQuestSaveGame* CurrentSaveGame;
