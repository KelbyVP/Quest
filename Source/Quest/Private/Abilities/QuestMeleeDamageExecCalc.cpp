...
UQuestMeleeDamageExecCalc::UQuestMeleeDamageExecCalc()
{
...
void UQuestMeleeDamageExecCalc::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
...
float UQuestMeleeDamageExecCalc::CalculateMeleeDamage(float Strength, float ArmorClass) const
{
	int8 StrengthAdjustment = (Strength / 2);
	StrengthAdjustment -= 5;
